...
import { User, Calendar, Users, Phone, MapPin, FileText } from "lucide-react";
...
export function CombinedPersonalDetails({ formData, handleInputChange }: PersonalDetailsProps) {
